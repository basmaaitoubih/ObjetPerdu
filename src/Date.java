...
/**
 * Classe qui modelise une date formee d'une annee, d'un mois, et d'un jour.
 * Classe fournie dans le cadre du TP3 INF1120 H23.
 * 
 * @author Melanie Lord
 * @version Hiver 2023
 */
public class Date {
   ...
   /**
    * Construit un objet Date avec le jour = 1, le mois = 1, et l'annee = ANNEE_MIN.
    */
   public Date() {
      this.jour = 1;
      this.mois = 1;
   ...
   /**
    * Initialise les attributs de cette date avec les valeurs passees en parametres. 
    * Ce constructeur ne verifie pas que la date creee est valide.
    *
   ...
   /**
    * Teste si cette date est plus petite que (anterieure a) la date passee en
    ...
    * @return une date initialisee a la date du jour (la date au moment
    *         de l'appel de cette methode).
    */
